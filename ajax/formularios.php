		...
		foreach ($imoveis as $key => $value) {
			...
			$data.='<div class="row-imoveis">
				...
				<div class="r2">
					...
					<p><i class="fa fa-info"></i> Preço: R$'.\Painel::converterMoney($value['preco']).'</p>
				</div>
			</div><!--row-imoveis-->';
		}
...
*/
  ...
  ";
	...
	$info = array('assunto'=>$assunto,'corpo'=>$corpo);
	 $mail = new Email('benites13.com,contato@benites13.com','Mfb@10203040','benite59');
                 $mail->addAdress('contato1@benites13.com','benite59');
                 $info = array('assunto'=>'Um novo email cadastrado com sucesso!','corpo'=>$email);
