...
<head>
	...
	<link href="<?php echo INCLUDE_PATH_PAINEL ?>css/style1.css" rel="stylesheet" />
</head>
<body>
...
<div class="menu">
	...
	<div class="items-menu">
		...
		<h2>Galeria Moto</h2>
		<a <?php selecionadoMenu('cadastrar-imagens'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>cadastrar-imagens">Cadastrar Imagens</a>
		<a <?php selecionadoMenu('visualizar-imagens'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-imagens">Vizualizar Imagens</a>
		<h2>Galeria Carro</h2>
		<a <?php selecionadoMenu('cadastrar-imagens1'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>cadastrar-imagens1">Cadastrar Imagens</a>
		<a <?php selecionadoMenu('visualizar-imagem1'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-imagens1">Vizualizar Imagens</a>
		<h2>Galeria Outros</h2>
		<a <?php selecionadoMenu('cadastrar-imagens2'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>cadastrar-imagens2">Cadastrar-imagens</a>
		<a <?php selecionadoMenu('visualizar-imagens2'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-imagens2">Vizualizar-imagens</a>
	</div><!--items-menu-->
	</div><!--menu-wraper-->
</div><!--menu-->
